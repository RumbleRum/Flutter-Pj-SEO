...
showTxt('취미는 ${recommActor['탐형']?['취미']}다. 사는곳은 ${recommActor['탐형']?['사는곳']} 다! 공유의 자동차는 ${recommActor['탐형']?['자동차']}다');

// 익명함수를 만들어서 특정함수에 값으로 전달한다!
  japanShip((){print('일본배 따운! 니뽄 비사아아앙!');});

  // 람다함수
  showTxt('"아직 신에게는 7척이 일제따운!! 천황나와!!" ${retVal(leeFight[0])} ');

  showTxt('"아직 신에게는 ${minus()}척이 일제따운!! 천황나와!!"');


// 구구단출력
gugu(9);
showTxt('옆사람도 불안하여 7단을외움');
gugu(7);
