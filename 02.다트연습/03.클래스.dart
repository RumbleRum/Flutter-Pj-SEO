...
void main(List<String> args) {
  ...
  // 상속 받은 Cat 찍어보기
  Cat c2 = Cat('페르시안 고양이', 13, "푸른색","고양이","개인적","포근함");
...
super(부모속성 초기화를해야할 새로운변수들){}

[ super 키워드]
부모클래스 자신을 가키킴

1. 사용상 super() 메서드로 쓰면 부모의 생성자임!
2. 하위/메서드 접근할수 있음 (편의상 super 생략도 가능함)
...
class Cat extends Pet{
  ...
  super('species', 'character', 'food'){
    ...
    print('부모 pet 클래스의 인기지수:${super.likePet}');
    // super 키워드는 부모클래스 자신을 가리킴
    // super.하위속성 / 메서드 접근 할 수 있음
    // 편의상 super 없이 바로사용 가능함!
  }
